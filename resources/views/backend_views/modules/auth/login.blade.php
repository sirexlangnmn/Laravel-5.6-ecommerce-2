...
<div class="login-box login-sidebar">
    <div class="white-box"> 
        ...
        {{-- Login Form                      --}}
        {{-- =============================== --}}
        <form action="{!! url('/backend-auth/login') !!}" method="POST" id="loginform" aria-label="Login">
            @csrf
            ...
            <div class="form-group m-t-40">
                <div class="col-xs-12">
                    <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="{{ __('E-Mail Address') }}" autofocus>
