...
<tr class="text-center">
    <td>
        {!! Form::open(['route'=>['orders.destroy', $order->id], 'method'=>'DELETE' ]) !!}
            ...
            {!! link_to_route('orders.show', '', $order->id, ['type'=>'submit', 'class'=>'btn btn-outline btn-circle btn-primary fa fa-list', 'data-toggle'=>'tooltip', 'title'=>'Show Details of this order record', 'target'=>'_blank'] ) !!}
